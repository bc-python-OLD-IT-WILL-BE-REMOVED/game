...
# Let's print the grid.
    _onl_()
    _ononl_(t3) if a == _ else _ononl_(t4) if a == ___ else _ononl_(t0)
    _ononl_(t1)
    _ononl_(t3) if d == _ else _ononl_(t4) if d == ___ else _ononl_(t0)
    _ononl_(t1)
    _ononl_(t3) if g == _ else _ononl_(t4) if g == ___ else _ononl_(t0)
    _onl_()
    _onl_(t2)
    _ononl_(t3) if b == _ else _ononl_(t4) if b == ___ else _ononl_(t0)
    _ononl_(t1)
    _ononl_(t3) if e == _ else _ononl_(t4) if e == ___ else _ononl_(t0)
    _ononl_(t1)
    _ononl_(t3) if h == _ else _ononl_(t4) if h == ___ else _ononl_(t0)
    _onl_()
    _onl_(t2)
    _ononl_(t3) if c == _ else _ononl_(t4) if c == ___ else _ononl_(t0)
    _ononl_(t1)
    _ononl_(t3) if f == _ else _ononl_(t4) if f == ___ else _ononl_(t0)
    _ononl_(t1)
    _ononl_(t3) if i == _ else _ononl_(t4) if i == ___ else _ononl_(t0)
    _onl_()
# Some usefus sums.
    sa = a + d + g
    sb = b + e + h
...
# We can play...",
        ...
        j = z
        while j:
            k = _i_(t8) if x == ___ else _i_(t9)
            nv1, nv2 = ("\u0061", "\u006a") if k == "\u0041\u0031" and a == __ else ("\u0062", "\u006a") if k == "\u0041\u0032" and b == __ else ("\u0063", "\u006a") if k == "\u0041\u0033" and c == __ else ("\u0064", "\u006a") if k == "\u0042\u0031" and d == __ else ("\u0065", "\u006a") if k == "\u0042\u0032" and e == __ else ("\u0066", "\u006a") if k == "\u0042\u0033" and f == __ else ("\u0067", "\u006a") if k == "\u0043\u0031" and g == __ else ("\u0068", "\u006a") if k == "\u0043\u0032" and h == __ else ("\u0069", "\u006a") if k == "\u0043\u0033" and i == __ else BUG
